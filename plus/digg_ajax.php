...
else
{
	...
	$digg = '<DIV class=up><A href="javascript:void()" onclick="postDigg(\'good\','.$id.');">'.$row['goodpost'].' </A></DIV>
<DIV class=down><A href="javascript:void()" onclick="postDigg(\'bad\','.$id.');">-'.$row['badpost'].' </A>
</DIV>';
}
AjaxHead();
echo $digg;
